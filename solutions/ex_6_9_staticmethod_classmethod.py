# Implement a static method validate_amount(amount) to check if an amount is
# positive and raise an exception otherwise in BankAccount class defined above.
# Use this method in withdraw and deposit methods to validate the amount
# received as parameter is positive.
